...
class Ui_scr_Main(object):
    def setupUi(self, scr_Main):
        ...
        self.pushButton_2 = QtWidgets.QPushButton(parent=self.Block)
        self.pushButton_2.setGeometry(QtCore.QRect(500, 10, 91, 91))
        ...
        self.pushButton_3 = QtWidgets.QPushButton(parent=self.Block)
        self.pushButton_3.setGeometry(QtCore.QRect(820, 10, 101, 91))
        ...
        self.tb_Overview.setCurrentIndex(0)
    ...
    def retranslateUi(self, scr_Main):
        ...
        self.pushButton_2.setText(_translate("scr_Main", "Add Block"))
        self.label_11.setText(_translate("scr_Main", "Change Block"))
        self.pushButton_3.setText(_translate("scr_Main", "Change Block"))
